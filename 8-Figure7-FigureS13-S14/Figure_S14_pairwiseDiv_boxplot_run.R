...
p5 <- clade.dat1 %>% ggplot(aes(x=clade, y = value, color=clade)) + 
  ...
  scale_x_discrete(labels = c("Euchromatin","Heterochromatin","Non-Y Cent", "Class1", "Class2", "Class3", "Class4", "Class4A")) #+
...
#pdf("/Users/lucashemmer/Documents/Figure_S14_Jockey-3_DmelRef_intraRegion_intraContig_pairwise.pdf",width=16,height=8)
